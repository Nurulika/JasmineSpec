...
#[derive(Debug)]
pub struct JasmineSpecProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JasmineSpecProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JasmineSpec processing");
    
    let mut processor = JasmineSpecProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JasmineSpecProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JasmineSpecProcessor::new(false);
